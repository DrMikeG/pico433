            ...
            for s in readable:
                ...
                if s is server_socket:
                    ...
                    if data:
                        ...
                        tree_on = r.find('?tree=on')
                        tree_off = r.find('?tree=off')
                        tree_toggle = r.find('?tree=toggle')
                        print('tree_on = ', tree_on)
                        print('tree_off = ', tree_off)
                        print('tree_toggle = ', tree_toggle)
                        ...
                        if tree_on > -1:
                            print("Transmit tree on")
                            transmit(treeOnCmd)                
                            treeOn = True
                            
                        if tree_off > -1:
                            print("Transmit tree off")                
                            transmit(treeOffCmd)  # Immediate return
                            treeOn = False
